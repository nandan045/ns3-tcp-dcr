...
protected:
  ...
  Time              m_instRtt;                  //!< Instantaneous Round Trip Time => Used for calculation of delayed time
  ...
  bool    m_dcrEnabled; 	      //!< DCR opion enabled
  ...
  // uint32_t               m_dcrRetxThresh {3};    //!< Fast Retransmit threshold in the case of DCR 
